...
public class Workspace extends PagedView
    ...
    public Workspace(Context context, AttributeSet attrs, int defStyle) {
        ...
        mGestureMode = Integer.valueOf(getDevicePrefs(getContext()).getString("pref_homescreen_dt_gestures", "0"));
    ...
    public void stripEmptyScreens() {
        ...
        for (int i = 0; i < total; i++) {
            ...
            if ((!(FeatureFlags.QSB_ON_FIRST_SCREEN && Utilities.qsbEnabled(getContext())) || id > FIRST_SCREEN_ID)
    ...
    private void updatePageContentAlpha() {
        ...
        for (int i = numCustomPages(); i < getChildCount(); i++) {
            ...
            if (child != null) {
                ...
                float alpha = 1 - (isInOverviewMode() ? 0 : Math.abs(scrollProgress));
    ...
    private void updateAccessibilityFlags(CellLayout page, int pageNo) {
        if (mState == State.OVERVIEW) {
            ...
            if (!(FeatureFlags.QSB_ON_FIRST_SCREEN && Utilities.qsbEnabled(getContext())) || pageNo > 0) {
